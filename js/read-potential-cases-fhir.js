...
(async () => {
  ...
  await fs.writeFile("anxiety-disorders-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("anxiety-disorders-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
